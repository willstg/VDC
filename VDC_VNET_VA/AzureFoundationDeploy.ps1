...
#Site 3:  Virginia MAG
$localparametersFilePath="C:\Users\WILLS\Source\Repos\VDC\VDC_VNET_VA\azuredeploy.parameters.json"
$localtemplateFilePath="C:\Users\WILLS\Source\Repos\VDC\VDC_VNET_VA\azuredeploy.json"
#Site 4:  Iowa MAG
